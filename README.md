...
To be submitted as requirement 02 for EE298 Second Sem 2021-2022 of Master of Engineering of Electrical Engineering program from University of the Philippines Diliman
...
Other hyperparameters that can be changed are epochs, number of classes, and batch size. The values below are used to train the model
